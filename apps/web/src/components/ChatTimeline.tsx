import type { ChatSession } from "@coding-agent-orchestrator/shared";
    ...
    return (
      <section className="chat-empty-state">
        <div className="chat-empty-card">
          ...
          <p>
            Pick an agent, adjust settings if needed, and send the first
            message. Use <code>Cmd/Ctrl+,</code> to open settings and{" "}
