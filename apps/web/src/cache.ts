...
const SNAPSHOT_KEY = "coding-agent-orchestrator:snapshot:v2";
const QUEUE_KEY = "coding-agent-orchestrator:queue";
const DRAFT_PREFIX = "coding-agent-orchestrator:draft:";
const UI_PREFERENCES_KEY = "coding-agent-orchestrator:ui-preferences";
const SESSION_NOTIFICATION_ACKS_KEY =
  "coding-agent-orchestrator:session-notification-acks";
const COMPLETION_NOTIFICATION_DELIVERIES_KEY =
  "coding-agent-orchestrator:completion-notification-deliveries";
const APP_STATE_KEY = "coding-agent-orchestrator:app-state";
