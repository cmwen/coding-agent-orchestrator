...
import type { OrchestratorWorkspace } from "./workspace.js";
...
function sessionIdFromTitle(title: string, timestamp: string): string {
...
export function orchestratorHistoryRoot(
  workspace: OrchestratorWorkspace
): string {
  return path.join(
...
export function orchestratorSchedulesRoot(
  workspace: OrchestratorWorkspace
): string {
  return path.join(
    workspace.agentsRoot,
